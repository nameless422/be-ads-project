...
| 文档入口 | `README.md`、`docs/README.md`、`docs/harness/` | 新人入口、AI 上下文、任务交接 | `make harness-check` |
...
- 改字段：同步 `docs/architecture/raw-trans-bi-field-lineage.md`。
- 改 Google Ads 真实接入：同步 `docs/runbooks/google-ads-test-to-real-runbook.md`。
